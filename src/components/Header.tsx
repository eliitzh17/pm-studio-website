  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        {/* Phone CTA */}
        <a
          href="https://wa.me/972526384355"
          target="_blank"
          rel="noopener noreferrer"
          className="hidden md:flex items-center gap-2 bg-[#25D366] text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#128C7E] transition-colors"
        >
      ...
      {isMobileMenuOpen && (
        <nav className="md:hidden bg-white/95 backdrop-blur-sm border-t border-gray-light mt-2 px-4 py-4 space-y-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="block text-center bg-[#25D366] text-white px-5 py-2.5 rounded-full text-sm font-medium"
          >
            WhatsApp
          </a>
        </nav>
