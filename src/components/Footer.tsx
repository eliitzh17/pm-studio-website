        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li>
                <FooterPhone name="אילנית" phone="0502654957" display="050-265-4957" whatsapp="972502654957" />
              </li>
              <li>
                <FooterPhone name="פנחס" phone="0526384355" display="052-638-4355" whatsapp="972526384355" />
              </li>
            </ul>
          </div>
        </div>
  ...
  return (
    <span className="flex items-center gap-2">
      ...
      <a
        ...
        className="text-[#25D366] hover:text-[#5DF291] transition-colors"
        title="WhatsApp"
      >
